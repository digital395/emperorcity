      ...
      <div className="absolute inset-0">
        ...
        <div
          className="
            ...
            to-transparent
            blur-[2px]
            mask-[radial-gradient(ellipse_at_top_left,black_0%,black_45%,transparent_80%)]
            [-webkit-mask-image:radial-gradient(ellipse_at_top_left,black_0%,black_45%,transparent_80%)]
          "
        />
        ...
        <div
          className="
            relative mx-auto
            flex h-full w-full max-w-[1567px]
            items-start
            px-5 pt-24
...
>
                <div
                  className="
                    ...
                    via-[#6D1715]
                    to-[#4B1012]
                    shadow-[0_5px_16px_rgba(84,18,21,0.22)]
                    transition-all duration-300
                    group-hover:-translate-y-0.5
                    group-hover:shadow-[0_8px_22px_rgba(84,18,21,0.3)]
                ...
                >
                  ...
                  <span
                    className="
                      absolute bottom-1.25 right-1.25
                      z-20 h-1.5 w-1.5 rounded-full
                      bg-[#D4AF37]
                      shadow-[0_0_7px_rgba(212,175,55,0.9)]
                    "
                  />
                </div>
                ...
                <div className="ml-2 sm:ml-2.5">
                  ...
                  <p className="mt-0.5 whitespace-nowrap font-[Poppins] text-[10px] font-semibold text-[#541215]/65 sm:text-[11px] md:text-xs">
                    Approved
                  </p>
                </div>
              </motion.div>
