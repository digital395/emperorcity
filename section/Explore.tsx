...
export default function SpaceForMore() {
  ...
  return (
    ...
    <section className="relative w-full overflow-hidden bg-[#541215]">
      <div className="pointer-events-none absolute -left-32 top-1/2 h-105 w-105 -translate-y-1/2 rounded-full bg-[#D4AF37]/[0.07] blur-[110px]" />

      <div className="pointer-events-none absolute -right-40 top-0 h-125 w-125 rounded-full bg-[#F1D77A]/[0.035] blur-[130px]" />

      <div className="pointer-events-none absolute -right-5 top-1/2 -translate-y-1/2 select-none font-[Marcellus] text-[220px] leading-none text-white/2.5 sm:text-[300px] md:-right-2.5 md:text-[420px] lg:text-[520px]">
        70
      </div>
        ...
        <div className="grid items-center gap-12 md:grid-cols-[0.85fr_1.5fr] md:gap-14 lg:grid-cols-[0.7fr_1.7fr] lg:gap-20">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="font-[Poppins] text-[9px] font-semibold uppercase tracking-[0.22em] text-[#F1D77A] sm:text-[10px]">
                Emperor City
              </span>
            </div>
            ...
            <div className="mt-7">
              ...
              <div className="mt-1 font-[Poppins] text-[11px] font-medium uppercase tracking-[0.22em] text-white/70 sm:text-[12px]">
          ...
          >
            <p className="font-[Poppins] text-[9px] font-semibold uppercase tracking-[0.22em] text-[#F1D77A] sm:text-[10px]">
              Make Space For More
            </p>
            ...
            <div className="mt-8 grid max-w-175 grid-cols-1 border-y border-white/10 sm:grid-cols-3">
              <div className="py-4 sm:border-r sm:border-white/10 sm:pr-5">
                ...
                <p className="mt-1 font-[Poppins] text-[9px] uppercase tracking-[0.12em] text-white/45">
                  Integrated Township
                </p>
              </div>
...
>
  <button
    ...
    className="
      ...
      hover:border-[#F1D77A]
      hover:bg-white
      hover:shadow-[0_14px_35px_rgba(212,175,55,0.18)]
      sm:h-12
      sm:w-47.5
      sm:text-[11px]
    "
