...
>
              ...
              <p
                ...
                "
              >
                With its strategic location, large-scale development,
                bigger plot options and upcoming connectivity,
                <span className="font-semibold text-[#711717]">
                  {" "}
                  Emperor City{" "}
                </span>
                is planned to offer both a place to build your home and
                an opportunity to invest in Tirunelveli&apos;s future.
              </p>
...
>
                <button
                  ...
                  className="
                    ...
                    tracking-[0.14em]
                    text-[#F1D77A]
                    shadow-[0_12px_35px_rgba(84,18,21,0.16)]
                    transition-all
                    duration-300
                    hover:-translate-y-1
                    hover:border-[#F1D77A]
                    hover:shadow-[0_18px_45px_rgba(84,18,21,0.22)]
                    active:scale-[0.98]
                  "
                >
